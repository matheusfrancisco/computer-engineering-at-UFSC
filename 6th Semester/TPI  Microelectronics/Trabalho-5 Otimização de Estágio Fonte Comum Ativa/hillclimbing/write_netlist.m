...
fprintf(fid,'M1 Vdd N001 N001 Vdd P_1u l=%.4fu w=%.4fu \n',x(5),x(4));
fprintf(fid,'M2 Vdd N001 vout Vdd P_1u l=%.4fu w=%.4fu \n',x(5),x(4));
fprintf(fid,'Iref N001 0 %.2fmA\n',x(6));
fprintf(fid,'M3 vout N002 0 0 N_1u l=%.4fu w=%.4fu \n',x(2),x(3));
fprintf(fid,'VGS N003 0 %.4f\n',x(1));
